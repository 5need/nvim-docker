...
-- better centering when doing stuff
-- vim.keymap.set('n', '<C-d>', '<C-d>zz')
-- vim.keymap.set('n', '<C-u>', '<C-u>zz')
vim.keymap.set('n', 'n', 'nzzzv')
vim.keymap.set('n', 'N', 'Nzzzv')

-- superior clipboard shenanigans
vim.keymap.set('x', 'p', [["_dP]])
vim.keymap.set('x', '<leader>p', 'p')
vim.keymap.set({ 'n', 'v' }, '<leader>d', [["_d]])
-- consider these for a rainy day when I want to completely separate
-- vim and system clipboards. To use these I need to disable that
-- clipboard=unnamedplus or whatever in this config
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        -- pickers = {}
        defaults = {
          file_ignore_patterns = { '%.min%.js$', '_templ%.go$', 'node_modules/' },
          mappings = {
            i = {
              ['<C-u>'] = false,
              ['<C-d>'] = false,
...
-- vim.g.node_host_prog = '/home/mccullen/.npm-packages/lib/node_modules/neovim/bin/cli.js'
